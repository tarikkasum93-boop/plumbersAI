...
export const glossaryData: GlossaryTerm[] = [
  { term: "PUE", definition: "Power Usage Effectiveness: the ratio of total facility power consumption to the power consumed by computing equipment. Lower is better (closer to 1.0)." },
  { term: "Direct Liquid Cooling", definition: "A cooling method where liquid coolant is brought directly to the hot components (like CPUs/GPUs) via cold plates." },
  { term: "CDU", definition: "Coolant Distribution Unit: Isolates facility water from the ultra-pure, finely calibrated coolant delivered to server hardware." },
  { term: "Primary Loop", definition: "Facility Water System (FWS): High-capacity facility infrastructure supplying chilled fluid to the exterior of the CDU." },
  { term: "Secondary Loop", definition: "Technology Cooling System (TCS): Surgically pure fluid circulating from the CDU directly to the processors." },
  { term: "Direct-to-Chip", definition: "A method (D2C) where coolant traverses through a cold plate affixed directly to the silicon die." },
  { term: "Cold Plate", definition: "A metal plate with micro-channels through which coolant flows, affixed directly to a heat-generating chip." },
  { term: "Quick Disconnect", definition: "Specialized hydraulic couplings enabling pressurized connections and disconnections with zero fluid leakage." },
  { term: "Manifold", definition: "The primary distribution headers bridging main lines to individual server chassis." },
  { term: "Immersion Cooling", definition: "Complete submersion of server hardware within engineered dielectric fluids." },
  { term: "Dielectric fluid", definition: "A fluid that does not conduct electricity, commonly used in immersion cooling." },
  { term: "Capacitive Sensing", definition: "Sensing ribbons that detect moisture droplets by registering minute fluctuations in electrical capacitance." },
  { term: "Ultrasonic Flow Meters", definition: "Non-invasive sensors clamped externally to piping, measuring acoustic wave transit times to calculate flow rate." },
  { term: "Differential Pressure", definition: "Continuously measuring fluid pressure upstream and downstream of a filtration unit to indicate progressive filter occlusion. Also known as DP." },
  { term: "Sensor Fusion", definition: "Aggregating multiple telemetry data streams (like pressure drop and pump vibration) to predict failures before they occur." },
  { term: "Dew Point", definition: "The temperature to which air must be cooled to become saturated with water vapor, leading to condensation." },
  { term: "Cavitation", definition: "When pump suction demands exceed available fluid flow, localized pressure drops cause the fluid to boil at ambient temperature." },
  { term: "Galvanic Corrosion", definition: "Integrating different metals within the same fluid loop without chemical inhibitors forms a microscopic battery, causing structural degradation." },
  { term: "Hot-Swapping", definition: "Execution of repairs and valve replacements while the facility remains fully energized." },
  { term: "Actuated Valving", definition: "Motorized or pneumatic valves engineered for millisecond response times." },
  { term: "UV Sterilization", definition: "Ultraviolet irradiation used to neutralize biological contaminants within tepid coolant loops." }
];
...
export const getCourseData = (unit: 'UK' | 'US'): CourseItem[] => [
  ...
  { type: 'slide', title: '2. PUE - The Metric of Efficiency', imageUrl: 'https://i.postimg.cc/ZYGtnDDn/1743592765366.png', content: `<p>Power Usage Effectiveness (PUE) is the ratio of total facility power consumption to the power consumed by computing equipment.</p><ul><li><b>PUE 1.5:</b> Legacy air-cooled data centers.</li><li><b>PUE 1.1:</b> Modern AI data centers utilizing direct liquid cooling.</li></ul><p>The operational imperative is driving this coefficient as close to 1.0 as physically possible.</p>` },
  { type: 'slide', title: '3. The Physics of Heat Transfer', imageUrl: 'https://i.postimg.cc/59hdykk6/data-10-00091-g001.webp', content: `<p>Thermal exchange is governed by the equation: Q = m × Cp × ΔT</p><p>If a primary filtration unit clogs, the mass fluid flow (m in \${flowRateUnit(unit)}) decreases. To maintain thermal extraction (Q), the temperature differential (ΔT) surges exponentially, triggering hardware throttling and catastrophic shutdowns.</p>` },
  { type: 'slide', title: '4. Piping Architecture', imageUrl: 'https://i.postimg.cc/X79MCcTX/images-(46).jpg', content: `<p>Coolant transport networks are suspended in overhead conveyances or routed beneath raised sub-flooring.</p><p>Copper is widely restricted due to its high potential to act as a catalyst for galvanic corrosion in complex, mixed-metal topologies.</p>` },
  { type: 'slide', title: '5. Galvanic Corrosion', imageUrl: 'https://i.postimg.cc/tRKQJmvc/1-s2-0-S0997754624000906-gr31.jpg', content: `<p>Integrating copper and aluminum within the same fluid loop without proper chemical inhibitors forms a microscopic battery. The metals structurally degrade themselves.</p><div class="tech-box">We are not merely mechanical operators; we are fluid chemists actively calibrating pH levels, inhibitor concentrations, and fluid conductivity.</div>` },
  { type: 'slide', title: '6. Pressure and Cavitation', imageUrl: 'https://i.postimg.cc/BZr9bwwv/download-(12).png', content: `<p>When pump suction demands exceed available fluid flow, localized pressure drops cause the fluid to boil at ambient temperature (approx. \${formatTemp(20, unit)}). This phenomenon is called Cavitation.</p><p>It sounds like gravel passing through the pump casing. The system must be halted immediately to prevent impeller disintegration.</p>` },
  ...
  // MODULE 2
  { type: 'slide', title: '7. What is a CDU?', imageUrl: 'https://i.postimg.cc/7YSv2MpN/what-is-a-cdu.jpg', content: `<p>The Coolant Distribution Unit (CDU) constitutes the circulatory heart of the loop. It physically isolates untreated facility water from the ultra-pure, finely calibrated coolant delivered to the server hardware.</p>` },
  { type: 'slide', title: '8. Primary vs. Secondary Loops', imageUrl: 'https://i.postimg.cc/15DxqcLs/download-(14).png', content: `<ul><li><b>Primary Loop (FWS):</b> High-capacity facility infrastructure supplying chilled fluid to the exterior of the CDU.</li><li><b>Secondary Loop (TCS):</b> The Technology Cooling System; surgically pure fluid circulating from the CDU directly to the processors.</li></ul>` },
  { type: 'slide', title: '9. Direct-to-Chip (D2C) Cooling', imageUrl: 'https://i.postimg.cc/VsxQvHH6/download-(13).png', content: `<p>Coolant traverses through a micro-channel Cold Plate—often less than a millimeter thick at the interface—affixed directly to the silicon die.</p>` },
  { type: 'slide', title: '10. Quick Disconnect (QD)', imageUrl: 'https://i.postimg.cc/xTLrzyW8/images-(14).png', content: `<p>Specialized hydraulic couplings enabling pressurized connections and disconnections with zero fluid leakage.</p><div class="tech-box">A distinct tactile and auditory "click" is required. Absent this verification, the O-ring seal is compromised.</div>` },
  { type: 'slide', title: '11. Manifold Architecture', imageUrl: 'https://i.postimg.cc/h4kWv33c/Different-types-of-flow-manifolds-A-dividing-B-combining-C-parallel-or-Z-manifold.png', content: `<p>The primary distribution headers bridging main lines to individual server chassis. These must be rigorously hydraulically balanced, ensuring identical fluid pressure for the first and last server in the rack.</p>` },
  { type: 'slide', title: '12. Immersion Cooling', imageUrl: 'https://i.postimg.cc/c4fqnMVH/images-(13).png', content: `<p>Complete submersion of server hardware within engineered dielectric fluids. This architecture utilizes no water—only specialized, non-conductive synthetic hydrocarbons or fluorochemicals.</p>` },
  { type: 'slide', title: 'Technique Spotlight: Two-Phase Immersion Cooling', imageUrl: '/image_0.png', content: `<ul class="space-y-4"><li><strong>Heat triggers low-temperature evaporation:</strong> The thermal output from the submerged server components causes the engineered dielectric fluid to reach its boiling point and turn into vapor.</li><li><strong>Vapor transfers heat out of bath:</strong> The buoyant vapor naturally rises, effectively carrying the extracted heat energy away from the hardware.</li><li><strong>Condenser coil cools and condenses vapor:</strong> A secondary chilled coil located at the top of the tank cools the vapor, forcing it to undergo a phase change back into liquid.</li><li><strong>Fluid flows back into bath to be reused:</strong> The newly cooled liquid rains back down into the primary fluid bath, completing an efficient, passive closed-loop cooling cycle.</li></ul>` },
  ...
  { type: 'slide', title: '14. Capacitive Sensing', imageUrl: 'https://i.postimg.cc/3J2MvCPD/images-(47).jpg', content: `<p>Sensing ribbons deployed beneath floor tiles that detect moisture droplets as small as a grain of rice by registering minute fluctuations in electrical capacitance.</p>` },
  { type: 'slide', title: '15. Ultrasonic Flow Validation', imageUrl: 'https://i.postimg.cc/YqQcWfJg/Transit-Time-Measurement-976x1024.webp', content: `<p>Non-invasive sensors clamped externally to piping, measuring acoustic wave transit times. If the inlet flow rate (${flowRateUnit(unit)}) exceeds the return rate, a systemic leak is occurring in the dark.</p>` },
  { type: 'slide', title: '16. Differential Pressure (DP)', imageUrl: 'https://i.postimg.cc/15DxqcL3/download-(34).jpg', content: `<p>Continuously measuring fluid pressure upstream and downstream of a filtration unit. An escalating differential indicates progressive filter occlusion.</p>` },
  ...
  // MODULE 4
  { type: 'slide', title: '19. Hot-Swapping Components', imageUrl: 'https://i.postimg.cc/jqp02kkK/blog-hot-swap-vs-cold-swap.webp', content: `<p>The execution of repairs and valve replacements while the facility remains fully energized, achieved by shunting fluid through redundant bypass circuits.</p>` },
  ...
  { type: 'slide', title: '46. The Digital Nervous System', imageUrl: 'https://i.postimg.cc/HsbGy4fp/download-(33).jpg', content: '<p>If you can\'t measure it, you can\'t manage it. Modern AI plumbers rely on dashboards, not just wrenches. You must learn to "see" the water through the telemetry data.</p><div class="tech-box mt-4"><strong>[AI Image Prompt]</strong> Photorealistic wide shot of a high-tech data center control room. Focus on a massive matte-black dashboard displaying liquid cooling telemetry, isometric pipe diagrams, and flow metrics in glowing neon cyan and NVIDIA green. Cinematic lighting, depth of field, 8k resolution.</div>' },
