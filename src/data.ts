...
export const getCourseData = (unit: 'UK' | 'US'): CourseItem[] => [
  ...
  { type: 'slide', title: '2. PUE - The Metric of Efficiency', imageUrl: '/app-3868285559868735488.png', content: `<p>Power Usage Effectiveness (PUE) is the ratio of total facility power consumption to the power consumed by computing equipment.</p><ul><li><b>PUE 1.5:</b> Legacy air-cooled data centers.</li><li><b>PUE 1.1:</b> Modern AI data centers utilizing direct liquid cooling.</li></ul><p>The operational imperative is driving this coefficient as close to 1.0 as physically possible.</p>` },
  { type: 'slide', title: '3. The Physics of Heat Transfer', imageUrl: '/app-3920953982847057920.png', content: `<p>Thermal exchange is governed by the equation: Q = m × Cp × ΔT</p><p>If a primary filtration unit clogs, the mass fluid flow (m in ${flowRateUnit(unit)}) decreases. To maintain thermal extraction (Q), the temperature differential (ΔT) surges exponentially, triggering hardware throttling and catastrophic shutdowns.</p>` },
  ...
  // MODULE 2
  { type: 'slide', title: '7. What is a CDU?', imageUrl: '/app-9168925501861056512.png', content: `<p>The Coolant Distribution Unit (CDU) constitutes the circulatory heart of the loop. It physically isolates untreated facility water from the ultra-pure, finely calibrated coolant delivered to the server hardware.</p>` },
  { type: 'slide', title: '8. Primary vs. Secondary Loops', imageUrl: '/app-7707447432296054784.png', content: `<ul><li><b>Primary Loop (FWS):</b> High-capacity facility infrastructure supplying chilled fluid to the exterior of the CDU.</li><li><b>Secondary Loop (TCS):</b> The Technology Cooling System; surgically pure fluid circulating from the CDU directly to the processors.</li></ul>` },
  { type: 'slide', title: '9. Direct-to-Chip (D2C) Cooling', imageUrl: '/app-6462775618476769280.png', content: `<p>Coolant traverses through a micro-channel Cold Plate—often less than a millimeter thick at the interface—affixed directly to the silicon die.</p>` },
  ...
  { type: 'slide', title: '11. Manifold Architecture', imageUrl: '/app-9473215589139333120.png', content: `<p>The primary distribution headers bridging main lines to individual server chassis. These must be rigorously hydraulically balanced, ensuring identical fluid pressure for the first and last server in the rack.</p>` },
  { type: 'slide', title: '12. Immersion Cooling', imageUrl: '/app-860027735391649792.png', content: `<p>Complete submersion of server hardware within engineered dielectric fluids. This architecture utilizes no water—only specialized, non-conductive synthetic hydrocarbons or fluorochemicals.</p>` },
  ...
  { type: 'slide', title: '15. Ultrasonic Flow Validation', imageUrl: '/app-8575003504140025856.png', content: `<p>Non-invasive sensors clamped externally to piping, measuring acoustic wave transit times. If the inlet flow rate (${flowRateUnit(unit)}) exceeds the return rate, a systemic leak is occurring in the dark.</p>` },
  { type: 'slide', title: '16. Differential Pressure (DP)', imageUrl: '/app-8433306232509177856.png', content: `<p>Continuously measuring fluid pressure upstream and downstream of a filtration unit. An escalating differential indicates progressive filter occlusion.</p>` },
  ...
  // MODULE 4
  { type: 'slide', title: '19. Hot-Swapping Components', imageUrl: '/app-1002844892461826048.png', content: `<p>The execution of repairs and valve replacements while the facility remains fully energized, achieved by shunting fluid through redundant bypass circuits.</p>` },
  ...
  { type: 'slide', title: '46. The Digital Nervous System', imageUrl: '/app-1378825703770116096.png', content: '<p>If you can\'t measure it, you can\'t manage it. Modern AI plumbers rely on dashboards, not just wrenches. You must learn to "see" the water through the telemetry data.</p><div class="tech-box mt-4"><strong>[AI Image Prompt]</strong> Photorealistic wide shot of a high-tech data center control room. Focus on a massive matte-black dashboard displaying liquid cooling telemetry, isometric pipe diagrams, and flow metrics in glowing neon cyan and NVIDIA green. Cinematic lighting, depth of field, 8k resolution.</div>' },
