...
export const getCourseData = (unit: 'UK' | 'US'): CourseItem[] => [
  ...
  { type: 'slide', title: '2. PUE - The Metric of Efficiency', content: `<p>Power Usage Effectiveness (PUE) is the ratio of total facility power consumption to the power consumed by computing equipment.</p><ul><li><b>PUE 1.5:</b> Legacy air-cooled data centers.</li><li><b>PUE 1.1:</b> Modern AI data centers utilizing direct liquid cooling.</li></ul><p>The operational imperative is driving this coefficient as close to 1.0 as physically possible.</p>` },
  { type: 'slide', title: '3. The Physics of Heat Transfer', content: `<p>Thermal exchange is governed by the equation: Q = m × Cp × ΔT</p><p>If a primary filtration unit clogs, the mass fluid flow (m in ${flowRateUnit(unit)}) decreases. To maintain thermal extraction (Q), the temperature differential (ΔT) surges exponentially, triggering hardware throttling and catastrophic shutdowns.</p>` },
  ...
  // MODULE 2
  { type: 'slide', title: '7. What is a CDU?', content: `<p>The Coolant Distribution Unit (CDU) constitutes the circulatory heart of the loop. It physically isolates untreated facility water from the ultra-pure, finely calibrated coolant delivered to the server hardware.</p>` },
  { type: 'slide', title: '8. Primary vs. Secondary Loops', content: `<ul><li><b>Primary Loop (FWS):</b> High-capacity facility infrastructure supplying chilled fluid to the exterior of the CDU.</li><li><b>Secondary Loop (TCS):</b> The Technology Cooling System; surgically pure fluid circulating from the CDU directly to the processors.</li></ul>` },
  { type: 'slide', title: '9. Direct-to-Chip (D2C) Cooling', content: `<p>Coolant traverses through a micro-channel Cold Plate—often less than a millimeter thick at the interface—affixed directly to the silicon die.</p>` },
  ...
  { type: 'slide', title: '12. Immersion Cooling', content: `<p>Complete submersion of server hardware within engineered dielectric fluids. This architecture utilizes no water—only specialized, non-conductive synthetic hydrocarbons or fluorochemicals.</p>` },
  ...
  { type: 'slide', title: '15. Ultrasonic Flow Validation', content: `<p>Non-invasive sensors clamped externally to piping, measuring acoustic wave transit times. If the inlet flow rate (${flowRateUnit(unit)}) exceeds the return rate, a systemic leak is occurring in the dark.</p>` },
  { type: 'slide', title: '16. Differential Pressure (DP)', content: `<p>Continuously measuring fluid pressure upstream and downstream of a filtration unit. An escalating differential indicates progressive filter occlusion.</p>` },
  ...
  // MODULE 4
  { type: 'slide', title: '19. Hot-Swapping Components', content: `<p>The execution of repairs and valve replacements while the facility remains fully energized, achieved by shunting fluid through redundant bypass circuits.</p>` },
  ...
  { type: 'slide', title: '46. The Digital Nervous System', content: '<p>If you can\'t measure it, you can\'t manage it. Modern AI plumbers rely on dashboards, not just wrenches. You must learn to "see" the water through the telemetry data.</p><div class="tech-box mt-4"><strong>[AI Image Prompt]</strong> Photorealistic wide shot of a high-tech data center control room. Focus on a massive matte-black dashboard displaying liquid cooling telemetry, isometric pipe diagrams, and flow metrics in glowing neon cyan and NVIDIA green. Cinematic lighting, depth of field, 8k resolution.</div>' },
